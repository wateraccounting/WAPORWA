...
def main(Dir, Startdate='2009-01-01', Enddate='2018-12-31', 
         ...
         version = 2, Waitbar = 1):
    """
    This function downloads yearly WaPOR RET data
    ...
    """
    print('\nDownload yealy WaPOR Reference Evapotranspiration data for the period %s till %s' %(Startdate, Enddate))
    ...
    for index,row in df_avail.iterrows():   
        ...
        filename='RET_WAPOR.v2.0_mm-year-1_annually_%s.tif' %(Date.strftime('%Y'))
