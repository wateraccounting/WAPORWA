...
def main(Dir, Startdate='2009-01-01', Enddate='2018-12-31', 
    ...
    """
    print('\nDownload monthly WaPOR precipitation data for the period %s till %s' %(Startdate, Enddate))
    ...
    for index,row in df_avail.iterrows():   
        ...
        filename='P_WAPOR.v2.0_mm-month-1_monthly_%s.%02s.tif' %(Date.strftime('%Y'), Date.strftime('%m'))
