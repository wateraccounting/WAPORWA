...
def main(Dir, Startdate='2009-01-01', Enddate='2018-12-31', 
    ...
    """
    print('\nDownload yearly WaPOR Interception data for the period %s till %s' %(Startdate, Enddate))
    ...
    for index,row in df_avail.iterrows():   
        ...
        filename='I_WAPOR.v2.0_level%s_mm-year-1_annually_%s.tif' %(level,Date.strftime('%Y'))
